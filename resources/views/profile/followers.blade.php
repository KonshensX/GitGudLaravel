    ...
    <div class="ui grid">
        <div class="row">
            <div class="sixteen wide column" >
                <input type="hidden" id="name" data-name="{{ $query }}"> 
                <div class="ui three cards" ng-controller="FollowersController" ng-init="init()">
...
@section('js')
    <script src="{{ URL::asset('client/controllers/FollowersController.js') }}"></script>
@endsection